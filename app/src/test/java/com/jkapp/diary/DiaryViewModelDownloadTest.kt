...
import com.jkapp.drive.DriveAuthRequiredException
import com.jkapp.drive.FakeDriveRepository
...
class DiaryViewModelDownloadTest {
    ...
    private lateinit var fakeRepository: FakeDiaryFirestoreRepository
    ...
    fun setUp() {
        ...
        fakeRepository = FakeDiaryFirestoreRepository()
